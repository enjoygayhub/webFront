...
Web 性能 = 用户感知性能（UPP）：响应速度、画面流畅度、可用时长等直观体验。
第一优先级是
...
## 性能检测
  ...
  + web API ：Navigation Timing ， Performance , PerformanceEntry ， PerformanceObserver
...
5. 代码方面：，减少DOM元素数量和深度，减少访问dom，避免各种形式重排重绘，避免直接修改样式，避免直接操作dom，React/vue避免重新渲染，重新计算
